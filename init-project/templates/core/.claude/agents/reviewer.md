...
<!-- AI-REVIEW-START -->
   For LLM-touching diffs: untrusted text reaching a prompt as instructions,
   unvalidated model output crossing a trust boundary, and unbounded token
   cost in a loop are blocking.
<!-- AI-REVIEW-END -->
