# Security: threat model and defenses for Pillarwatch
...
Security profile (from the setup interview, B8): reads untrusted content: **no**; holds private data: **no**; acts on the outside world: **yes**.
