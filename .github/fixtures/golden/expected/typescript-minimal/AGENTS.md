...
Primary user: A docs maintainer who keeps finding broken links after release.. Stack: TypeScript; frontend: no; AI features: none; dev container: no.
...
<!-- ForgeWorks: Linkcheck | TypeScript | bootstrapped 2026-07-12 -->
