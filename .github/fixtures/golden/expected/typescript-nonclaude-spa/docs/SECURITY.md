# Security: threat model and defenses for Ledgerline
...
Security profile (from the setup interview, B8): reads untrusted content: **no**; holds private data: **yes**; acts on the outside world: **no**.
