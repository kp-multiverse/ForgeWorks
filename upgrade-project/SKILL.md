...
```bash
npx --yes degit@2.8.4 kp-multiverse/ForgeWorks/init-project/templates/core#v4.4.2 /tmp/upgrade-core --force
npx --yes degit@2.8.4 kp-multiverse/ForgeWorks/init-project/templates/profiles/<lang>#v4.4.2 /tmp/upgrade-profile --force
npx --yes degit@2.8.4 kp-multiverse/ForgeWorks/init-project#v4.4.2 /tmp/upgrade-skill --force
```
...
Reconcile against this skill's own released version (`v4.4.2`), not `main`: installing the `vX.Y.Z` upgrade skill brings a project *up to* `vX.Y.Z` -- a versioned, reviewable target. (Each release bumps this ref; see the repo `AGENTS.md` release process.)
